...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
        ...
        <p className='text-sm md:text-base text-gray-500 mt-3'>Discover our top rated corses across various categories. From Coding and design to <br/> buisness and wellness, our courses are crafted to deliver results</p>
